...
#if _ELPP_OS_UNIX
#   if _ELPP_NDK
        setAll(ConfigurationType::Filename, "/data/local/tmp/serverlist.txt");
#   else
        setAll(ConfigurationType::Filename, "/tmp/logs/serverlist.log");
#   endif // _ELPP_NDK
#elif _ELPP_OS_WINDOWS
        setAll(ConfigurationType::Filename, "comMP//serverlist.log");
#endif // _ELPP_OS_UNIX
